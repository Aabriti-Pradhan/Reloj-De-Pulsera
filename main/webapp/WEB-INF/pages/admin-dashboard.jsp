		...
		<% request.setAttribute("activePage", "dashboard"); %>
	        ...
	        <div class="content">
	            ...
	            <div class="kpi">
	                <div class="kpi-box">
	                    <p>Revenue</p>
	                    <h4>Rs. <fmt:formatNumber value="${revenue}" type="number" maxFractionDigits="2"/></h4>
	                </div>
	                <div class="kpi-box">
	                    <p>Net</p>
	                    <h4>Rs. <fmt:formatNumber value="${net}" type="number" maxFractionDigits="2"/></h4>
	                </div>
	                <div class="kpi-box">
	                    <p>Pending Orders</p>
	                    <h4>${pendingOrders}</h4>
	            ...
	            <div class="customer-table">
				    <div class="table-header">
				        <h3>Top Customers by Orders</h3>  <!-- Changed title -->
				        <a href="#">View All</a>
				    </div>
				    <table>
				        <thead>
